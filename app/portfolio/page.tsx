...
function StatCard({
  ...
  return (
    ...
    >
      <span
        className="text-[9px] uppercase tracking-[0.15em] text-[#2A3545] mb-2"
      ...
      {sub && (
        <span
          className="text-[10px] text-[#5A6478]"
          style={{ fontFamily: "var(--font-jetbrains)" }}
        >
          {sub}
        </span>
      ...
      >
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <StatCard
            ...
            sub={`≈ ${(totalValue / 148).toFixed(1)} SOL`}
            color="#E8EDF5"
          />
          <StatCard
            label="24h PnL"
            ...
            color={totalPnl >= 0 ? "#00FF85" : "#FF3B3B"}
            accent={totalPnl > 0}
          />
          <StatCard
            label="Open Positions"
            value={String(openCount)}
            sub={`${new Set(positions.map((p) => p.wallet)).size} wallets`}
            color="#00D4FF"
          />
          <StatCard
            label="Win Rate (7d)"
            ...
            color={
              winRate >= 60 ? "#00FF85" : winRate >= 45 ? "#FFB800" : "#FF3B3B"
            }
          />
        </div>

        <div
          className="border border-[#111822]"
          style={{ background: "#080C14" }}
        >
          <div className="flex items-center justify-between px-4 py-3 border-b border-[#111822]">
            <div className="flex items-center gap-3">
              <span
                className="text-[9px] uppercase tracking-[0.15em] text-[#5A6478]"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                Active Positions
              </span>
              <span
                className="text-[9px] px-2 py-0.5 border border-[#00FF85]/20 text-[#00FF85]"
                style={{
                  fontFamily: "var(--font-jetbrains)",
            ...
            <span
              className="flex items-center gap-1.5 text-[9px] text-[#00FF85]"
              style={{ fontFamily: "var(--font-jetbrains)" }}
            >
          ...
          <div
            className="hidden sm:grid px-4 py-2 border-b border-[#111822]"
            style={{
          ...
          {positions.map((p) => (
            <div
              ...
              style={{
                gridTemplateColumns:
                  "1fr 80px 110px 110px 90px 160px 70px 80px",
              }}
            >
              <div className="flex items-center gap-2">
                <div
                ...
                <div>
                  <p
                    className="text-[11px] text-[#D0D8E8] font-medium"
                    style={{ fontFamily: "var(--font-jetbrains)" }}
                  >
                    ${p.token}
                  </p>
                  <p
                    className="text-[9px] text-[#2A3545] sm:hidden"
                    style={{ fontFamily: "var(--font-jetbrains)" }}
                  >
                    {p.wallet}
                  </p>
              ...
              <span
                className="text-[10px] text-[#5A6478] text-right hidden sm:block"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {p.qty}
              </span>
              ...
              <span
                className="text-[10px] text-[#8892A4] text-right hidden sm:block tabular-nums"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {fmtPrice(p.current)}
              </span>
              ...
              <span
                className="text-[11px] text-[#D0D8E8] text-right tabular-nums"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {fmtUsd(p.value)}
              </span>
              ...
              <span
                className="text-[9px] text-[#2A3545] text-right hidden sm:block"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {fmtAge(p.ageMinutes)}
              </span>
              ...
              <div className="flex justify-end">
                <button
                  className="px-2 py-1 text-[8px] uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-opacity"
                  style={{
                    fontFamily: "var(--font-jetbrains)",
                    color: "#FF3B3B",
          ...
          >
            ...
            <span />
            <span
              className="text-[12px] font-bold text-[#E8EDF5] text-right tabular-nums"
              style={{ fontFamily: "var(--font-jetbrains)" }}
            >
              {fmtUsd(totalValue)}
            </span>
            <div className="hidden sm:flex justify-end">
              ...
              >
                {fmtUsd(totalPnl, true)} ({totalPnl >= 0 ? "+" : ""}
        ...
        >
          <div className="flex items-center justify-between px-4 py-3 border-b border-[#111822]">
            <div className="flex items-center gap-3">
              ...
              <span
                className="text-[9px] px-2 py-0.5 text-[#00FF85]"
                style={{
                  fontFamily: "var(--font-jetbrains)",
                  background: "rgba(0,255,133,0.06)",
          ...
          >
            {["Token", "Type", "Entry", "Exit", "PnL", "Hold", "Closed"].map(
              (h, i) => (
                <span key={i} className={i > 1 ? "text-right" : ""}>
                  {h}
                </span>
          ...
          {SEED_CLOSED.map((t, i) => (
            ...
            >
              ...
              <span
                className="text-[10px] text-[#3A4558] text-right hidden sm:block tabular-nums"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {fmtPrice(t.entry)}
              </span>
              ...
              <div className="text-right hidden sm:block">
                ...
                <p
                  ...
                  style={{
                    fontFamily: "var(--font-jetbrains)",
                    color: t.pnl >= 0 ? "#00FF8580" : "#FF3B3B80",
                  }}
                >
                  {t.pnl >= 0 ? "+" : ""}
                  {t.pnlPct.toFixed(1)}%
              ...
              <span
                className="text-[9px] text-[#2A3545] text-right"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {t.closedAgo}
              </span>
