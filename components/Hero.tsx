...
function DashboardMockup() {
  ...
  return (
    <div
      className="relative w-full overflow-hidden border border-[#1C2535]"
      style={{ background: "#07090F" }}
    >
      <div
        className="flex items-center justify-between px-3 py-2 border-b border-[#1C2535]"
      ...
      <div
        className="flex border-b border-[#1C2535]"
        style={{ background: "#07090F" }}
      >
        {["New Tokens", "Trending", "Copy Trades", "Alerts"].map((tab, i) => (
          <button
            key={tab}
            className="px-3 py-2 text-[9px] uppercase tracking-widest border-b-2 transition-colors"
            style={{
              fontFamily: "var(--font-jetbrains)",
      ...
      <div
        className="grid px-3 py-1.5 border-b border-[#1C2535]"
        style={{
      ...
      {TOKENS.map((t, i) => (
        ...
        >
          ...
          <div className="flex justify-end">
            <button
              className="px-2 py-0.5 text-[8px] font-bold uppercase tracking-wider transition-all hover:brightness-125"
              style={{
                fontFamily: "var(--font-jetbrains)",
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(0,255,133,0.06) 0%, transparent 70%)",
          }}
        />
        <div
          className="absolute left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#00FF85]/12 to-transparent"
          style={{ animation: "scanline 8s linear infinite", top: 0 }}
        />
      </div>

      {[
        "top-20 left-4 sm:left-8 border-l border-t",
        "top-20 right-4 sm:right-8 border-r border-t",
        "bottom-8 left-4 sm:left-8 border-l border-b",
        "bottom-8 right-4 sm:right-8 border-r border-b",
      ].map((cls, i) => (
        <div
          key={i}
          className={`absolute ${cls} w-6 h-6 border-[#00FF85]/25 pointer-events-none`}
        />
      ))}
      ...
      <div className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          <div>
            ...
            <h1
              className="leading-none tracking-wide mb-4 animate-float-up delay-100"
              style={{
            ...
            >
              ...
              <span
                ...
                style={{ textShadow: "0 0 40px rgba(0,255,133,0.35)" }}
              >
                The Whales
              </span>{" "}
              Do.
            ...
            <p
              className="text-[#5A6478] mb-8 animate-float-up delay-200"
              style={{
            ...
            >
              Snipe launches, copy smart wallets, and manage positions in one
              workspace — built for{" "}
              <span className="text-[#E8EDF5] font-semibold">speed</span>,{" "}
              <span className="text-[#E8EDF5] font-semibold">density</span>, and{" "}
              <span className="text-[#E8EDF5] font-semibold">trust</span> (the
              bar real traders set). Execute in{" "}
            ...
            >
              ...
              <Link
                href="#how-it-works"
                className="btn-ghost text-sm sm:inline-flex"
              >
                How It Works
              </Link>
            </div>
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 opacity-25">
        <span
          className="text-[9px] text-[#5A6478] uppercase tracking-widest"
          style={{ fontFamily: "var(--font-jetbrains)" }}
        >
          scroll
        </span>
