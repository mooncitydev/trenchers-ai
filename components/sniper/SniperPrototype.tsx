    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 px-4 py-3 border-b border-trench-line-subtle bg-trench-panel/90 overflow-x-auto flex-shrink-0">
        <div className="min-w-0">
          <p
            className="text-[10px] uppercase tracking-[0.14em] text-trench-accent font-medium"
            style={{ fontFamily: "var(--font-jetbrains)" }}
          >
            New pairs
          </p>
          <p
            className="text-xs text-trench-label mt-0.5"
            style={{ fontFamily: "var(--font-dm-sans)" }}
          >
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                <TokenAvatar
                  imageIndex={idx}
                  fallbackLetter={row.name}
                  size="md"
                  up
                />
                <div className="min-w-0">
                  <p
                    className="text-[#E8EDF5] font-semibold truncate"
                    style={{ fontFamily: "var(--font-jetbrains)" }}
                  >
                    ${row.name}
                  </p>
                  <p
                    className="text-[9px] text-trench-dim sm:hidden"
                    style={{ fontFamily: "var(--font-jetbrains)" }}
                  >
                    {row.age} · {row.mcap}
                  </p>
              ...
              <span
                className="text-[10px] text-trench-label text-right hidden sm:block"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {row.age}
              </span>
              <span
                className="text-[10px] text-[#E8EDF5] text-right hidden sm:block tabular-nums"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {row.mcap}
              </span>
              <span
                className="text-[10px] text-trench-dim text-right hidden sm:block"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {row.liq}
              </span>
              <span
                className="text-[10px] text-amber-400 text-right hidden sm:block"
                style={{ fontFamily: "var(--font-jetbrains)" }}
              >
                {row.risk}
              </span>
      ...
      <p
        className="px-4 py-2.5 text-[10px] text-trench-dim border-t border-trench-line-subtle bg-trench-panel/80"
        style={{ fontFamily: "var(--font-jetbrains)" }}
      >
