    ...
    <div className="flex flex-col flex-1 overflow-hidden">
      <div className="flex items-center justify-between px-4 h-11 border-b border-trench-line-subtle flex-shrink-0 bg-trench-panel/90">
        <div className="flex items-center gap-4 min-w-0">
          <span
            className="text-[10px] uppercase tracking-[0.12em] text-trench-label font-medium truncate"
            style={{ fontFamily: "var(--font-jetbrains)" }}
          >
            {selectedWalletId ? "Filtered feed" : "All trades"} (
            {visible.length})
          </span>
          <div className="flex items-center gap-3">
            <span
              className="flex items-center gap-1 text-[9px] text-[#00FF85]"
              style={{ fontFamily: "var(--font-jetbrains)" }}
            >
              <span>▲</span>
              {buys} buys
            ...
            <span
              className="flex items-center gap-1 text-[9px] text-[#FF3B3B]"
              style={{ fontFamily: "var(--font-jetbrains)" }}
            >
              <span>▼</span>
              {sells} sells
        ...
        {selectedWalletId && (
          <span
            className="text-[9px] text-trench-dim hidden sm:inline"
            style={{ fontFamily: "var(--font-jetbrains)" }}
          >
      ...
      <div
        className="hidden sm:grid items-center px-4 h-9 border-b border-trench-line-subtle flex-shrink-0 bg-trench-bg"
